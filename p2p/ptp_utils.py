...
# 将AttentionController注册到stablediffusionpipeline里
def register_attention_control(model, controller, is_controlnet=False):
    def ca_forward(self, place_in_unet):
        ...
        def forward(hidden_states, encoder_hidden_states=None, attention_mask=None,temb=None,):
            ...
            with torch.no_grad():
                ...
                # 计算出attn weights后，使用controller编辑
        ...
        # 如果是视频生成，batchsize太大，为了避免显存不足，使用多个controller。
    ...
    # 将unet里AttentionBlock的forward方法替换掉
